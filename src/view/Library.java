...
public class Library extends JFrame {
	...
	private JRadioButton rbAllBooks, rbInLib, rbBorBooks, rbTitle, rbCod;
	...
	public Library() {
		...
		researchesPanel.setLayout(null);
			...
			filterPanel.setLayout(null);
				...
				rbAllBooks = new JRadioButton("Todos os Livros", true);
				rbAllBooks.setBounds(5, 44, 120, 15);
				rbAllBooks.setOpaque(false);
				rbAllBooks.setFont(font);
				
				rbInLib = new JRadioButton("Na Biblioteca", false);
				rbInLib.setBounds(125, 44, 120, 15);
				rbInLib.setOpaque(false);
				rbInLib.setFont(font);
				
				rbBorBooks = new JRadioButton("Livros Emprestados", false);
				rbBorBooks.setBounds(225, 44, 145, 15);
				rbBorBooks.setOpaque(false);
				rbBorBooks.setFont(font);
			...
			searchPanel.setLayout(null);
				...
				rbTitle = new JRadioButton("Titulo", false);
				rbTitle.setBounds(5, 36, 120, 15);
				rbTitle.setOpaque(false);
				rbTitle.setFont(font);
				
				rbCod = new JRadioButton("Código", false);
				rbCod.setBounds(125, 36, 120, 15);
				rbCod.setOpaque(false);
				rbCod.setFont(font);
		...
		filterPanel.add(rbAllBooks);
		filterPanel.add(rbInLib);
		filterPanel.add(rbBorBooks);
		filterPanel.add(btnFilter);
		
		// --- Adiciona Itens no Painel de Pesquisa ---
		searchPanel.add(label2);
		searchPanel.add(rbTitle);
		searchPanel.add(rbCod);
		searchPanel.add(text);
		searchPanel.add(btnFind);
		
		// --- Adiciona RadioButton no Grupo ---
		group1 = new ButtonGroup();
		group1.add(rbAllBooks);
		group1.add(rbInLib);
		group1.add(rbBorBooks);
